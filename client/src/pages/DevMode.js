...
const DevMode = () => {
    return (
        <>
            <h2>To Do's</h2>
            <ol style={{ margin: '2%' }}>
                <li style={{ margin: '1%', fontSize: '23px' }}>Add Recipes to DB</li>
                <ul>
                    <li style={{ margin: '1%', fontSize: '23px' }}>Create a page for each recipe that shows all details of the recipe</li>
                </ul>
